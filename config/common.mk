...
ifeq ($(TARGET_BUILD_VARIANT),eng)
  ...
  ifeq ($(TARGET_ENABLE_ADB),true)
    # Disable ADB authentication and enable adb mode
    PRODUCT_SYSTEM_DEFAULT_PROPERTIES += ro.adb.secure=0 persist.sys.usb.config=mtp,adb
  else
